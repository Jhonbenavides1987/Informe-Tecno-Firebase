...
const UploadCalendariosPage = ({ user }) => {
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} md={3}>
                        <Paper elevation={3} sx={{ p: 2, position: 'sticky', top: 20 }}>
                            ...
                            <Button fullWidth variant="contained" color="error" size="small" onClick={() => handleDeleteCollection('Implementacion_Calendarios')} sx={{ mt: 1 }} disabled={isDeleting.impl || !user} startIcon={<DeleteForever />}>
                            ...
                            <Button fullWidth variant="contained" color="error" size="small" onClick={() => handleDeleteCollection('MetasCalendarios')} sx={{ mt: 1 }} disabled={isDeleting.meta || !user} startIcon={<DeleteForever />}>
