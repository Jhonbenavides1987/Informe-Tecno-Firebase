...
const PortaAfichesDataTable = () => {
    ...
    useEffect(() => {
        ...
        // Apuntamos a la nueva colección de progreso para Porta Afiches
        const progressRef = collection(db, "ProgresoPortaAfiches");
    ...
    if (progressData.length === 0) {
        return <Alert severity="info">Aún no hay datos de progreso para mostrar para Porta Afiches.</Alert>;
    }
...
const DashboardPortaAfichesPage = () => {
    return (
        <motion.div
        ...
        >
            <Container maxWidth="xl">
                <Typography variant="h4" component="h1" gutterBottom sx={{ fontWeight: 'bold', color: 'primary.main' }}>
                    Dashboard de Implementación de Porta Afiches
                </Typography>
                <Typography variant="subtitle1" color="text.secondary" sx={{ mb: 3 }}>
                    Visualización del progreso de implementación de porta afiches por sucursal contra la meta establecida.
                </Typography>
                
                <PortaAfichesDataTable />
...
export default DashboardPortaAfichesPage;
